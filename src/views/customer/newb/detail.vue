<template>
  <div>
    ...
    <!-- 订单分析 -->
    <div v-if="niandudtos.show || jidudtos.show || yuedudtos.show"
      ...
      <div class="mt-5 grid grid-cols-3 gap-x-6">
        ...
        <div v-if="niandudtos.show" class="w-full">
          <div class="flex items-center space-x-2">
            <div class="w-1.5 h-1.5 rounded-full bg-primary-focus" />
            <h3>年度</h3>
          </div>
    ...
    <div class="mt-5 w-full bg-white shadow-lg px-6 pt-4 pb-6 rounded-box">
      <h2>订单数据</h2>
      <base-pagination :params="params" url="/home/userInfo/getAllOrder" :size="5" class="mt-4">
            ...
            <table class="table table-zebra min-w-full">
              ...
              <tbody class="text-sm text-gray-500">
                <tr v-for="(item, index) in slotProps.list" :key="index">
                  ...
                  <!-- 操作/查看信息 -->
                  <td>
                    <button class="btn btn-link text-primary-focus px-0 btn-xs font-normal underline hover:font-bold"
